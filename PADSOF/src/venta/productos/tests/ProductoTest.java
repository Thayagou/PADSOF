...
class ProductoTest {
	...
	void setUp() throws Exception {
		...
		producto = new Comic("Spiderman", "Comic de Spiderman", 10.0, null, LocalDate.of(2020, 1, 1), "Stan Lee", 100, "Marvel", cat1);
	}
    ...
    void testGetIdUnico() throws Exception{
    	Producto otro = new Comic("Batman", "Comic de Batman", 12.0, null, LocalDate.of(2021, 1, 1), "Bob Kane", 80, "DC");
    ...
    void testAnadirResenaYPuntuacionMedia() throws Exception {
        ClienteRegistrado u1 = new ClienteRegistrado("Cliente1", "pass");
        ClienteRegistrado u2 = new ClienteRegistrado("Cliente2", "pass");
    ...
    void testGetResenas() throws Exception {
        ClienteRegistrado u = new ClienteRegistrado("Cliente", "pass");
