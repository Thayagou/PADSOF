...
class CategoriaTest {
    ...
    void testAnadirDescuentoConProductoQueYaTieneDescuento() throws Exception {
        // Si un producto de la categoría ya tiene descuento, no se puede añadir a la categoría
        Descuento dProducto = new DescuentoPorcentaje(0, LocalDateTime.MIN, LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION, 10);
