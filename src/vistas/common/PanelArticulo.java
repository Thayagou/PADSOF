...
public class PanelArticulo extends PanelDisplay {
	...
	public PanelArticulo (String nombreUsuario, String fotoDePerfil,  String nombre, String descripcion, String interesadoEn, double estimacion, String estado, String actionName, String...categorias) {
		...
		//JButton iconoUsuario = f.newIconButton(nombreUsuario, maxCompHeight, maxCompHeight/2, fotoDePerfil);
		//iconoUsuario.setMaximumSize(new Dimension(t.getPixelsWidth(BOTON_PERC_W), maxCompHeight));
		int gapSize = (int) (maxCompHeight * (1 - 2*BOTON_PERC_H) / 2);
		usuario.add(Box.createVerticalStrut(gapSize));
		//usuario.add(iconoUsuario);
		//usuario.setMaximumSize(new Dimension(t.getPixelsWidth(BOTON_PERC_W), maxCompHeight));
		usuario.add(iconoUsuario);
	...
	public PanelArticulo (String nombre, String descripcion, String interesadoEn, double estimacion, String estado, String actionName, String...categorias){
		...
		/* Info: estrellas + nombre + descripción + precio + categorías */
			articulo = new JPanel();
			articulo.setOpaque(false);
			articulo.setLayout(new GridLayout(1, 3));
	...
	public void inicializarBoton(String nombre) {
		...
		//eastPanel.setMaximumSize(new Dimension(maxWidth, (int)(maxCompHeight * BOTON_PERC_H)));
