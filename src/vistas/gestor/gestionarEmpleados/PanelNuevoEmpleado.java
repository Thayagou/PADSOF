...
public class PanelNuevoEmpleado extends PanelDisplay {
	...
	private void expandPanel() {
		if (expandedPanel == null) {
			...
			nombreEmpleado = ButtonFactory.newTextField("Nombre", Fonts.TEXT);
			JLabel label = new JLabel("Introduzca el nombre");
			label.setFont(Fonts.TEXT.getFont());
			JPanel textField = new JPanel(new BorderLayout());
			textField.setOpaque(false);
			textField.add(label, BorderLayout.NORTH);
			textField.add(nombreEmpleado, BorderLayout.CENTER);
