package modelo.venta.descuentos.tests;
...
class DescuentoSubTest {
	...
	void testDescuentoPorcentajeValido() {
		assertDoesNotThrow(() -> new DescuentoPorcentaje(0, LocalDateTime.MIN, LocalDateTime.MAX,
	...
	void testDescuentoPorcentajeCero() {
		assertDoesNotThrow(() -> new DescuentoPorcentaje(0, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, 0));
	}

	@Test
	void testDescuentoPorcentajeCien() {
		assertDoesNotThrow(() -> new DescuentoPorcentaje(0, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, 100));
	}

	@Test
	void testDescuentoPorcentajeNegativo() {
		assertThrows(InvalidArgumentException.class, () -> new DescuentoPorcentaje(0, LocalDateTime.MIN,
				LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION, -1));
	}

	@Test
	void testDescuentoPorcentajeMayorDeCien() {
		assertThrows(InvalidArgumentException.class, () -> new DescuentoPorcentaje(0, LocalDateTime.MIN,
				LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION, 101));
	}
	...
	void testDescuentoDineroValido() {
		assertDoesNotThrow(() -> new DescuentoDinero(0, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, 5.0));
	}

	@Test
	void testDescuentoDineroCero() {
		assertDoesNotThrow(() -> new DescuentoDinero(0, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, 0.0));
	}

	@Test
	void testDescuentoDineroNegativo() {
		assertThrows(InvalidArgumentException.class, () -> new DescuentoDinero(0, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, -1.0));
	}
	...
	void testDescuentoDineroAplicado() throws Exception {
		Descuento d = new DescuentoDinero(0, LocalDateTime.MIN, LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION,
				4.0);
	...
	void testDescuentoRegaloValido() {
		assertDoesNotThrow(() -> new DescuentoRegalo(0, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, regalo));
	}

	@Test
	void testDescuentoRegaloNull() {
		assertThrows(InvalidArgumentException.class, () -> new DescuentoRegalo(0, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, null));
	}
	...
	void testDescuentoRegaloDevuelveRegalo() throws Exception {
		Descuento d = new DescuentoRegalo(0, LocalDateTime.MIN, LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION,
				regalo);
