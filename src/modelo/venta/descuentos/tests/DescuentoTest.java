...
class DescuentoTest {
	...
	void setUp() throws Exception {
		Producto p = new Comic("Spiderman", "Comic de Spiderman", 10.0, null, LocalDate.of(2020, 1, 1), "Stan Lee", 100,
				"Marvel");
		descPorc = new DescuentoPorcentaje(0, LocalDateTime.MIN, LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION,
				10);
	...
	void testConstructorValorMinNegativo() throws Exception {
		assertThrows(InvalidArgumentException.class, () -> new DescuentoPorcentaje(-1, LocalDateTime.MIN,
				LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION, 10));
	}

	@Test
	void testConstructorInicioNull() throws Exception {
		assertThrows(InvalidArgumentException.class,
				() -> new DescuentoPorcentaje(0, null, LocalDateTime.MAX, CondicionDescuento.SIN_CONDICION, 10));
	}

	@Test
	void testConstructorFinNull() throws Exception {
		assertThrows(InvalidArgumentException.class,
				() -> new DescuentoPorcentaje(0, LocalDateTime.MIN, null, CondicionDescuento.SIN_CONDICION, 10));
	}

	@Test
	void testConstructorCondicionNull() throws Exception {
		assertThrows(InvalidArgumentException.class,
				() -> new DescuentoPorcentaje(0, LocalDateTime.MIN, LocalDateTime.MAX, null, 10));
	}
	...
	void testGetIdUnico() throws Exception {
		Descuento otro = new DescuentoPorcentaje(0, LocalDateTime.MIN, LocalDateTime.MAX,
	...
	void testIsVigenteNoEmpezado() throws Exception {
		Descuento noEmpezado = new DescuentoPorcentaje(0, Reloj.now().plusHours(1), LocalDateTime.MAX,
				CondicionDescuento.SIN_CONDICION, 10);
	...
	void testCumpleCondicionesCantidadSuficiente() throws Exception {
		Descuento dCantidad = new DescuentoPorcentaje(3, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.CANTIDAD, 10);
	...
	void testCumpleCondicionesVolumenSuficiente() throws Exception {
		Descuento dVolumen = new DescuentoPorcentaje(50, LocalDateTime.MIN, LocalDateTime.MAX,
				CondicionDescuento.VOLUMEN, 10);
